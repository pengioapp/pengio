  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "title-medium": ["20px", { lineHeight: "1.4", fontWeight: "500" }],
        ...
        "body-micro": ["12px", { lineHeight: "1.5", fontWeight: "400" }],
      },
      colors: {
        ...
        pengio: {
          green: "hsl(var(--pengio-green))",
          "green-hover": "hsl(var(--pengio-green-hover))",
          blue: "hsl(var(--pengio-blue))",
          orange: "hsl(var(--pengio-orange))",
          purple: "hsl(var(--pengio-purple))",
        },
