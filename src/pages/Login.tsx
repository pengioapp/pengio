        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5 flex-1">
          <div>
            ...
            <div className="flex items-center gap-3 bg-secondary rounded-xl px-4 py-3.5">
              ...
              <input type="email" value={email} onChange={(e) => { setEmail(e.target.value); setError(""); }} placeholder={t("login.enterEmail")} className="flex-1 bg-transparent text-body-standard text-foreground placeholder:text-muted-foreground outline-none" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 bg-secondary rounded-xl px-4 py-3.5">
              <Search className="w-4 h-4 text-muted-foreground" />
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder={t("login.enterPassword")} className="flex-1 bg-transparent text-body-standard text-foreground placeholder:text-muted-foreground outline-none" />
            </div>
          </div>
