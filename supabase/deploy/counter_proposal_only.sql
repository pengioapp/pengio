-- Pengio: the one piece of counter-offers that never reached the database.
--
-- Checked against the live project on 2026-09-08:
--   loan_proposals.counter_to      EXISTS
...
--
-- Safe to paste in one go: no new enum values here, so no transaction problem.
